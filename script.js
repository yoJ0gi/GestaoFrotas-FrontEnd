...
// ================= SISTEMA DE CONFIGURAÇÕES (MEDFLEET) =================
...
function initSettingsPage() {
  ...
  // Notificações - auto salvamento ao alterar switches/dropdowns
  ...
  // Dark Mode - Sincronização nos dois sentidos
  ...
  // Manter sincronizado se alterar pela barra lateral
...
function loadUserProfile() {
  ...
  // Atualizar topbar e boas-vindas
  ...
  // Ícone correspondente na topbar
...
// Sintetizador Web Audio API para reproduzir bipes de alertas offline
function playAlertSound(type) {
  ...
  if (type === "sirene") {
    // Sirene de Ambulância (Frequência alternada de emergência)
    osc.type = "sine";
